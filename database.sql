...
CREATE TABLE "answers" (
	...
	"fundingReceived4" INTEGER NOT NULL,
	"customerGrowth4" INTEGER NOT NULL,
	"generatingRevenue4" BOOLEAN NOT NULL,
	...
	"addressableMarket5" INTEGER NOT NULL,
	"serviceableMarket5" INTEGER NOT NULL,
	"obtainableMarket5" INTEGER NOT NULL,
	"whyRealistic5" VARCHAR (2048) NOT NULL,
